...
export declare function sendCustomerMessage(conversationId: string, text: string): Promise<void>;
...
export declare function deleteTopicByThreadId(threadId: number): Promise<void>;
...
export declare function sendGroupMessage(text: string, threadId?: number): Promise<void>;
